...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    @Override               //find transaction information with exception handling
    ...
    public Transaction findById(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        try {
            ...
            throw new EtResourceNotFoundException("Transaction note found");
        }
    }
    ...
    @Override               //Update SQL transaction information with exception handling
    ...
    @Override               //Delete SQL transactions with exception handling
    public void removeById(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        ...
        if(count == 0)
            throw new EtResourceNotFoundException("Transaction no found");
    }
