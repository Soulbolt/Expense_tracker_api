...
public class CategoryRepositoryImpl implements CategoryRepository{
    private static final String SQL_FIND_ALL = "SELECT C>CATEGORY_ID, C.USER_ID, C.TITLE, C.DESCRIPTION,  "
            + "COALESCE(SUM(T.AMOUNT), 0) TOTAL_EXPENSES"
    ...
    @Override                   //use of jdbc to query database to find, update, create, remove with authorization and
    public List<Category> findAll(Integer userId) throws EtResourceNotFoundException {  //exception handling
