...
@Repository
public class UserRepositoryImpl implements UserRepository {     //SQL Statements
    ...
    @Override    //Create tables with crypted passwords using JBcrypt, keyholders, and hash passwords for extra security
    public Integer create(String firstName, String lastName, String email, String password) throws EtAuthException {
        ...
        try {
            ...
            throw new EtAuthException("Invalid details. Failed to create account");
                                            ...
                                            //Verify if email/password is correct
    @Override
